...
export default function AllJob({ jobs, onApply, onSave, emptyMessage }: Props) {
  if (!jobs.length) {
    return (
        ...
        return (
          ...
          >
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-xs uppercase tracking-[0.28em] text-slate-400">A hiring manager will respond within 48 hours</p>
              {job.isApplied ? (
                <Button
                  disabled
